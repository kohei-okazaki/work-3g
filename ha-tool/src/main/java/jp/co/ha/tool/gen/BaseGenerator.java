...
public abstract class BaseGenerator {
	...
	private ToolProperty readProp() throws URISyntaxException {
		...
		try {
			// 設定ファイルを取得
			ToolProperty prop = new PropertyReader().read(classDir, "tool.properties", ToolProperty.class);
	...
	public static enum GenerateType implements BaseEnum {
		...
		ENTITY("ENTITY", "ha-db\\src\\main\\java\\jp\\co\\ha\\db\\entity", EntityGenerator.class),
		/** DDL作成 */
		DDL("DDL", "ha-resource\\02_db\\ddl", CreateTableGenerator.class),
		/** DROP作成 */
		DROP("DROP", "ha-resource\\02_db\\drop", DropSqlGenerator.class),
		/** テーブル定義作成 */
		TABLE_DEFINE("TABLE_DEFINE", "ha-resource\\02_db\\others", TableDefineGenerator.class);
