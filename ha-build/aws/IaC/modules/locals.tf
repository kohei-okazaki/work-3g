...
locals {
  ...
  service_discovery_namespace_name = "${local.resource_dns_label}.local"
  api_service_discovery_name       = "ha-api"
  root_api_service_discovery_name  = "ha-root"
  track_service_discovery_name     = "ha-track"

  db_master_password_parameter_name      = "/${local.resource_prefix}/db/master/password"
  db_app_password_parameter_name         = "/${local.resource_prefix}/db/app/password"
  track_django_secret_key_parameter_name = "/${local.resource_prefix}/ha-track/django-secret-key"
  ...
  api_internal_base_url      = "http://${local.api_service_discovery_name}.${local.service_discovery_namespace_name}/api/"
  root_api_internal_base_url = "http://${local.root_api_service_discovery_name}.${local.service_discovery_namespace_name}/api/root/"
  track_internal_hostname    = "${local.track_service_discovery_name}.${local.service_discovery_namespace_name}"
  track_internal_base_url    = "http://${local.track_internal_hostname}/api/"
  track_django_allowed_hosts = var.track_django_allowed_hosts != "" ? var.track_django_allowed_hosts : local.track_internal_hostname
  ...
  dashboard_environment = concat(
    [
      ...
      { name = "HEALTHINFO_API_URL", value = local.api_internal_base_url },
    ],
