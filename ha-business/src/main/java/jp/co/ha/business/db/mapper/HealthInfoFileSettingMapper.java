...
public interface HealthInfoFileSettingMapper {
     ...
     * This method corresponds to the database table health_info_file_setting
     *
     ...
     * @mbg.generated Sun Sep 09 15:50:12 JST 2018
     */
    int updateByExampleSelective(@Param("record") HealthInfoFileSetting record, @Param("example") HealthInfoFileSettingExample example);
     ...
     * @mbg.generated Sun Sep 09 15:50:12 JST 2018
     */
    int updateByExample(@Param("record") HealthInfoFileSetting record, @Param("example") HealthInfoFileSettingExample example);
