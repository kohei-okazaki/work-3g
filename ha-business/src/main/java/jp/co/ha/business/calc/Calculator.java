...
public class Calculator {
    ...
    public static enum CalcMethod {
        ...
        /** 和 */
        ADD((target1, target2, digit, roudingMode) -> target1.add(target2).setScale(digit,
                roudingMode)),
        /** 差 */
        SUBTRACT((target1, target2, digit, roudingMode) -> target1.subtract(target2)
                .setScale(digit, roudingMode)),
        /** 積 */
        MULTIPLY((target1, target2, digit, roudingMode) -> target1.multiply(target2)
                .setScale(digit, roudingMode)),
        /** 商 */
        DIVIDE((target1, target2, digit, roudingMode) -> target1.divide(target2, digit,
                roudingMode));
