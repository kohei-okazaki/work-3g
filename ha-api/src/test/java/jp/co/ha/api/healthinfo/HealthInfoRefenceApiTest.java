...
public class HealthInfoRefenceApiTest extends BaseApiTest {
	...
	public void testReference() {
		try {
			...
			RequestEntity<?> requestEntity = new RequestEntity<>(json, headers, HttpMethod.POST, uri);

			ResponseEntity<HealthInfoReferenceResponse> responseEntity = this.client.exchange(requestEntity,
