...
public class JsonReader {
	...
	public <T> T read(File json, Class<T> clazz) throws BaseException {
		try {
			...
			throw new SystemException(CommonErrorCode.RUNTIME_ERROR, json.getName() + "をjavaクラスへの変換に失敗しました", e);
		}
		return null;
	}
	...
	public String read(Object bean) throws BaseException {
		try {
			...
			throw new SystemException(CommonErrorCode.JSON_MAPPING_ERROR, bean + "をJSON文字列への変換に失敗しました", e);
		}
	}
}
