...
class HealthInfoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = HealthInfo
        fields = ["height", "weight", "bmi", "bmi", "standard_weight", "created_at"]
...
class HealthTrackLogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["id", "seq_user_id", "synced_at", "created_at", "health_info"]
    ...
    def create(self, validated_data):
        ...
        health_track_log = HealthTrackLog.objects.create(health_info=health_info, **validated_data)
