  ...
  data: function () {
    return {
      breadcrumbs: [
        ...
        {
          text: "日次健康情報データ分析連携バッチ",
          disabled: true,
          href: "/healthinfoapp/batch/daily/healthinfo",
        },
      ],
      flow: [
        {
          id: "1",
          text: "日次健康情報データ分析連携バッチJavaを呼び出す",
          edgeType: "round",
          next: ["2"],
        },
        {
        ...
        {
          id: "5",
          text: "取得した健康情報をCSVファイルに出力し、gzip圧縮する",
          edgeType: "round",
          next: ["6"],
        },
        {
          id: "6",
          text: "健康情報ファイルをS3へアップロードする",
          edgeType: "round",
          next: ["7"],
        },
        {
