$(function() {
  ...
  $("#bmi-modal").on("click", function() {
    ...
    $("body").append('<div id="bmi-modal-content"><div class="modal-layout"><b>BMI</b><br> <label>計算式</label><br><div align="center" class="modal-layout formula"> <label>体重(kg) / (身長(m) × 身長(m))</label></div><br><div align="center" class="modal-layout"><table class="data"><tr class="data"><th class="data"><label>範囲</label><th class="data"><label>肥満度</label><tr class="data"><td class="data"><label>18以下</label><td class="data"><label>低体重</label><tr class="data"><td class="data"><label>18 ~ 25未満</label><td class="data"><label>普通体重</label><tr class="data"><td class="data"><label>25 ~ 30未満</label><td class="data"><label>肥満(1)</label><tr class="data"><td class="data"><label>30 ~ 35未満</label><td class="data"><label>肥満(2)</label><tr class="data"><td class="data"><label>35 ~ 40未満</label><td class="data"><label>肥満(3)</label><tr class="data"><td class="data"><label>40以上</label><td class="data"><label>肥満(4)</label></table></div></div></div>');
    $("#bmi-modal-content").css({
      "display" : "none",
      "width" : "auto",
      "height" : "auto",
